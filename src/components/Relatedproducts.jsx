...
console.log("data from  related",data)
  ...
  return (
    <div className='bg-[#232F3E] h-[auto] sm:h-[auto] sm:px-[1vw]   sm:mt-[10vh] mt-[8vh] py-[2vh] '>
...

{
  isLoading ? <p className='text-white '>Loading..</p> :(
    <>
    <div className='bg-[#232F3E] sm:h-[auto] h-[auto] sm:ml-0 ml-[6.5vw] overflow-y-auto  sm:pt-[2vh]  px-[10px]'>
