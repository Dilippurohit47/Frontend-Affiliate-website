  ...
  return (
    <div className="  sm:mt-[-4px] overflow-y-hidden  h-auto  pt-[10vh] sm:pt-[8vh]  ">
      ...
      <div className="h-[auto] w-[100v%] mt-[4vw]    flex-col sm:flex-row  flex   sm:px-[10vw] px-[1vw]  ">
        <div className="sm:h-[55vh] h-[45vh]    justify-center flex sm:ml-[5vw] sm:w-[140vw] sm:border-[2px] hover:border-[0]  px-[1vw] ">
          <img
        ...
        <div className="  w-[auto] ml-[2vw] sm:mt-0 mt-[3vh] sm:ml-[5vw]">
          ...
          <p className=" w-[auto] sm:w-[40vw pr-[2.5vw]   leading-[1.25rem] text-[0.9rem] text-[#000000df]">
            {product?.desc}
          </p>
